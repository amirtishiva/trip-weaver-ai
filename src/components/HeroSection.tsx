      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          >
            ...
            <Link to="/discover">
              <Button variant="hero-outline" size="lg" className="text-base px-8 py-6 border-primary-foreground/40 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground">
